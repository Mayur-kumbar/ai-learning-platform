...
// TEMP ROLE LOGIC (since backend doesn't send role)
const role = user ? "instructor" : null;

 const router = useRouter();

  useEffect(() => {
    // ✅ UPDATED MOCK DATA (STATUS BASED)
    setLectures([
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-[#0f172a] via-[#020617] to-black text-white">
      ...
      <div className="flex-1 p-8 space-y-6">
        ...
        <motion.div
          ...
          className="p-6 rounded-2xl bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-white/10 backdrop-blur-xl flex justify-between items-center"
        >
          <div>
            ...
            <div className="w-64 mt-4">
              ...
              <div className="w-full h-3 bg-white/10 rounded-full">
                <div className="h-3 w-[68%] bg-gradient-to-r from-cyan-400 to-green-400 rounded-full" />
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {/* ✅ CURRENT COURSES (UPDATED WITH STATUS) */}
          ...
          <GlassCard title="Overall Progress">
            <p className="text-red-400 font-semibold">LIVE Webinar</p>
          ...
          <GlassCard title="Upcoming Events">
            <p className="text-red-400">LIVE Webinar</p>
            <p className="mt-2">Live webinar or something</p>

            <button className="mt-4 w-full bg-gradient-to-r from-cyan-400 to-green-400 text-black py-2 rounded-xl font-semibold hover:scale-105 transition">
              Sign Up
            </button>
          </GlassCard>
...
function GlassCard({ title, children }) {
  return (
    ...
    >
      <div className="absolute inset-0 opacity-0 hover:opacity-100 transition duration-500 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 blur-xl"></div>
